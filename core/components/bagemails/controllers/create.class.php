 ...
 */
class BagEmailsCreateManagerController extends modExtraManagerController {
    ...
    */
    ...
    public function loadCustomCssJs() {
        ...
        $this->addLastJavascript($jsUrl.'widgets/default.window.js');
        $this->addLastJavascript($jsUrl.'widgets/form/form.window.js');
        $this->addLastJavascript($jsUrl.'widgets/form/form.panel.js');
        $this->addLastJavascript($jsUrl.'widgets/form/form.grid.js');
        $this->addLastJavascript($jsUrl.'form/form.js');

        $this->addHtml('<script>
            bagemails.config = '.$this->modx->toJSON($this->bagemails->config).';
           
            Ext.onReady(function() {
                MODx.add({xtype: "bagemails-page-form"});
            });
        </script>');
    }
}
